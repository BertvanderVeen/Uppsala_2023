...
\begin{equation}
\eta_{ij} = \beta_{0j} + \boldsymbol{z}_i^\top\boldsymbol{\gamma}_j \color{red}{- \boldsymbol{z}_i\boldsymbol{D}_k\boldsymbol{z}_i}
\end{equation}
...
\color{red}{\boldsymbol{z}_i} &= \boldsymbol{B}^\top\boldsymbol{x}_i + \boldsymbol{b}^\top\boldsymbol{u}_j + \boldsymbol{\epsilon} \\
\color{blue}{\boldsymbol{\gamma}_j} &= \boldsymbol{\omega}^\top\boldsymbol{T}_j + \boldsymbol{w}^\top\boldsymbol{\lambda}_i + \boldsymbol{\epsilon}
\end{aligned}
...
# Tomorrow: model-based ordination in R
