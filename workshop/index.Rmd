...
https://github.com/BertvanderVeen/Uppsala_2023
...
<b> We can quantitatively assess what makes a good ordination </b>
...
I will briefly go through the different model-based ordination packages <br>
...
- "the GLM bit"
- $\color{green}{\eta_{ij}}$ is the linear predictor
- and $\mu_{ij} = \color{brown}{g^{-1}}(\eta_{ij})$
...
# Step 1: Start by plotting the data
...
```{r, fig.align="center", out.width = "80%", echo=F}
knitr::include_graphics("Kumar.png")
```
...
# Step 2: Fit unconstrained ordination
...
# Step 3: Fit concurrent ordination
...
# Step 6: Random canonical coefficients

```{r, echo=T, eval=F}
# Predictor-based shrinkage
ftCN2 <- update(ftCN,randomB="P")
```

```{r, echo=F, eval=T}
# Predictor-based shrinkage
load("/home/bertv/Dropbox/Uppsala/workshop/examples/ftCN2.RData")
ftCN2$params$LvXcoef
```
...
```{r, echo=F, eval=T}
load("/home/bertv/Dropbox/Uppsala/workshop/examples/ftCN3.RData")
ftCN3$params$LvXcoef
```
